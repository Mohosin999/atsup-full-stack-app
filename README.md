...
Why npm start was broken — and how I fixed it 🚧                                                                                                                                                 
                                                                                                                                                                                                      
     My Node/TypeScript backend was running fine in dev (tsx) but crashed in production with:                                                                                                         
                                                                                                                                                                                                      
     ERR_MODULE_NOT_FOUND: Cannot find module './dist/app'                                                                                                                                            
                                                                                                                                                                                                      
     The real problem? My package.json had "type": "module", so Node used strict ESM — which requires file extensions in imports (./app.js, not ./app).                                               
     But tsc with bundler resolution emits imports verbatim, so the compiled code had extensionless paths.                                                                                            
                                                                                                                                                                                                      
     The trap: Switching to CommonJS also failed, because the Prisma 7 generated client uses import.meta.url (ESM-only) — so CJS output crashed with                                                  
     exports is not defined.                                                                                                                                                                          
                                                                                                                                                                                                      
     The fix that just works: esbuild bundling:                                                                                                                                                       
                                                                                                                                                                                                      
     esbuild src/server.ts --bundle --platform=node --format=esm --outfile=dist/server.js                                                                                                             
                                                                                                                                                                                                      
     esbuild resolves extensionless imports at build time and bundles everything into one file — no source changes, no post-build hacks, and it survives                                              
     prisma generate.                                                                                                                                                                                 
                                                                                                                                                                ⬖ Getting started                ✕    
     Lesson: If you use ESM, don't fight Node's extension rules — use a bundler like esbuild and let the build step handle resolution. 🚀 
