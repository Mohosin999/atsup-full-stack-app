...
import { parseJobDescription as parseJDService, mapAIToStructuredJD, } from "./services/jobDescription.service";
import { createAtsScoreHistory, getAtsScoreHistory, getAtsScoreHistoryById, deleteAtsScoreHistory, deleteAllAtsScoreHistory, renameAtsScoreHistory, } from "./services/history.service";
...
const mapAIResearchToResumeContent = (ai) => {
    if (!ai)
        return null;
    return {
        personalInfo: {
...
export const parseResume = async (req, res) => {
    try {
        ...
        try {
            const result = await parseResumeService(req.file.path, req.file.originalname, req.file.mimetype);
...
export const analyzeAtsScore = async (req, res) => {
    try {
        ...
        const score = await createAtsScoreHistory(req.user.id, resumeName || "Untitled Resume", resumeContent, finalStructuredJD || null, aiResearch || null);
...
// ─── History CRUD ────────────────────────────────────────────────────────────
export const getAtsScores = async (req, res) => {
    try {
...
export const deleteAtsScoreController = async (req, res) => {
    try {
        const { id } = req.params;
...
export const deleteAllAtsScoresController = async (req, res) => {
    try {
...
export const renameAtsScoreController = async (req, res) => {
    try {
        const { id } = req.params;
