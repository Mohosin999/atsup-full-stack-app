...
import { parseResume, parseJobDescription, analyzeAtsScore, getAtsScores, getAtsScore, deleteAtsScoreController, deleteAllAtsScoresController, renameAtsScoreController, } from "./atsScoreCheck.controller";
const router = Router();
