...
import { scoreFromChecks, scoreFromSubgroups, deriveFeedback, collectResumeDates, } from "./utils";
// ============================================================
// Contact Info
// ============================================================
const buildContactInfoSubgroup = (resume) => {
...
// Section Headings
// ============================================================
const buildSectionHeadingsSubgroup = (resume) => {
...
// Job title match
// ============================================================
const buildJobTitleSubgroup = (resumeText, jd) => {
...
// Date Formatting
// ============================================================
const buildDateFormattingSubgroup = (resume) => {
...
// Education Match
// ============================================================
const buildEducationMatchSubgroup = (jd, eduScore) => {
...
// Build
// ============================================================
export const buildSearchability = (resume, resumeText, jd, eduScore) => {
    const subgroups = [
