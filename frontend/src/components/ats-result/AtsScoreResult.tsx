...
export default function AtsScoreResult({ result, onRescan }: AtsScoreResultProps) {
  ...
  return (
    <div className="font-plex space-y-6">
      {result.sectionScores.categories ? (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 xl:gap-10 items-start">
          {/* LEFT: score circle + checklist of what was checked */}
          <div className="lg:col-span-4 xl:col-span-3 lg:sticky lg:top-24">
          ...
          <div className="lg:col-span-8 xl:col-span-9 space-y-6">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
            >
              <h2 className="font-fraunces text-lg font-normal text-stone-900 dark:text-stone-50 mb-4">
                Improvement suggestions
              </h2>
              <SuggestionList
                suggestions={result.suggestions}
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="md:col-span-2 bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-2xl p-6">
              <h2 className="font-fraunces text-xl font-normal text-stone-900 dark:text-stone-50 mb-4">
                Summary
              </h2>
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="bg-lime-50 dark:bg-lime-400/10 border border-lime-200 dark:border-lime-400/20 rounded-xl p-4">
                  <p className="text-stone-600 dark:text-stone-400 text-sm mb-1">ATS Friendliness</p>
