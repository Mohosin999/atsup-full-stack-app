...
// const getScoreColor = (score: number) => {
//   if (score < 40) return "#A8A29E"; // stone-400 — needs work
//   if (score < 70) return "#F59E0B"; // amber-500 — getting there
//   return "#84CC16"; // lime-500 — strong
// };
...
//   return (
//     <div className="font-plex relative inline-flex flex-col items-center justify-center">
//       {label && (
//         <p className="mb-4 text-base lg:text-lg font-semibold text-stone-700 dark:text-stone-300">
//           {label}
//         </p>
//       )}
...
//             className="text-center"
//           >
//             <span className={`${textSize} font-semibold text-stone-800 dark:text-stone-100`}>
//               {score}
//               <span className="text-xl font-medium text-stone-500 dark:text-stone-400">%</span>
//             </span>
//           </motion.div>
//         </div>
//       </div>
