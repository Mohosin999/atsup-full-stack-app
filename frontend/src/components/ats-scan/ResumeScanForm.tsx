    ...
    <div className="font-plex">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
        ...
        <div className="flex flex-col">
          <div className="flex items-center gap-3 mb-4">
            <div
              className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${resumeFile ? "bg-lime-200 text-stone-800" : "bg-stone-100 dark:bg-stone-800 text-stone-500 dark:text-stone-400"}`}
            >
              {resumeFile ? <CheckCircle className="w-5 h-5" /> : "1"}
            </div>
            <h2 className="text-lg xl:text-xl font-semibold text-stone-900 dark:text-stone-100">
              Upload resume
            </h2>
          </div>

          {resumeFile ? (
            <div className="relative min-h-[280px] flex flex-col items-center justify-center border-2 border-dashed border-lime-300 bg-lime-50 dark:bg-lime-400/5 dark:border-lime-400/30 rounded-xl">
              <div className="flex flex-col items-center gap-2">
                <div className="w-12 h-12 rounded-full bg-lime-200 dark:bg-lime-400/20 flex items-center justify-center">
                  <CheckCircle className="w-7 h-7 text-stone-800 dark:text-lime-300" />
                </div>
                <p className="text-sm font-medium text-stone-800 text-center px-4 dark:text-stone-100">
                  {resumeName}
                </p>
              </div>
              <button
                ...
                className="absolute bottom-2 right-2 inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium text-stone-700 dark:text-stone-300 bg-white dark:bg-stone-800 border border-stone-300 dark:border-stone-700 hover:bg-red-50 hover:text-red-600 hover:border-red-300 rounded-lg transition-colors"
              >
                <X className="w-3.5 h-3.5" />
                Clear
              </button>
            ...
            <label className="relative min-h-[280px] flex flex-col items-center justify-center border-2 border-dashed border-stone-300 dark:border-stone-700 bg-white dark:bg-stone-900 hover:bg-stone-50 dark:hover:bg-stone-800/60 cursor-pointer rounded-xl transition-colors">
              <Upload className="w-8 h-8 text-stone-500 dark:text-stone-400 mb-2" />
              ...
              <p className="text-xs text-stone-500 mt-1 dark:text-stone-500">
                PDF only (MAX. 5MB)
              </p>
              <input
                type="file"
        ...
        <div className="flex flex-col">
          <div className="flex items-start justify-between gap-3 mb-4">
            <div className="flex items-center gap-3">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${jobDescription.trim().length >= 20 ? "bg-lime-200 text-stone-800" : "bg-stone-100 dark:bg-stone-800 text-stone-500 dark:text-stone-400"}`}
              >
                {jobDescription.trim().length >= 20 ? (
                  <CheckCircle className="w-5 h-5" />
                ) : (
