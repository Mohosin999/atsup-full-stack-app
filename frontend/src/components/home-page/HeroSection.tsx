            ...
            <div className="text-4xl md:text-5xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-bold text-gray-700 md:space-y-3 xl:space-y-4">
              ...
              <h1>
                ...
                <span className="relative inline-block px-1">
                  ...
                  {/* Marker Effect */}
                  <span className="absolute left-0 right-0 bottom-1 h-8 md:h-10 lg:h-8 xl:h-10 2xl:h-12 bg-cyan-200/80 rounded-sm -rotate-1 -z-0" />
                </span>
              </h1>
            </div>

            {/* Description */}
            <p className="my-8 lg:my-6 xl:my-8 text-base xl:text-lg text-gray-700 max-w-xl mx-auto lg:mx-0">
