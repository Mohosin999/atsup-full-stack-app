...
export default function HowItWorksTabs() {
  ...
  return (
    <section className="font-plex bg-stone-50 dark:bg-stone-950 py-16 md:py-20 lg:py-24 xl:py-28">
      <Wrapper>
        {/* header */}
        <div className="text-center mb-8 lg:mb-10">
          ...
          <h2 className="font-fraunces mt-4 text-2xl md:text-3xl xl:text-4xl font-normal text-stone-900 dark:text-stone-50">
            Everything you need to get hired
          </h2>
