          ...
          {features.map((feature) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-lg 2xl:text-xl font-semibold text-gray-800 mb-3 text-center">
                  {feature.title}
                </h3>
                <p className="text-sm 2xl:text-base text-gray-700 text-center leading-relaxed">
                  {feature.description}
                </p>
              </div>
            </motion.div>
