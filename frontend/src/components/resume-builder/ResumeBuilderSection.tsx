  ...
  return (
    ...
    >
      <div className={`font-plex bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl overflow-hidden ${className}`}>
        <div className="px-4 py-3">
          {editing ? (
            <div className="w-full flex items-center justify-between text-left min-w-0">
              ...
              <ChevronDown
                className={`w-4 h-4 text-stone-500 dark:text-stone-400 flex-shrink-0 transition-transform duration-200 ml-2 ${
                  open ? "rotate-180" : ""
                }`}
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              {sortable && (
                <button
                  ...
                  {...sortable.listeners}
                  title="Drag to reorder section"
                  className="text-stone-400 dark:text-stone-500 hover:text-stone-700 dark:hover:text-stone-300 cursor-grab active:cursor-grabbing flex-shrink-0 touch-none"
                >
                  <GripVertical className="w-4 h-4" />
                </button>
              )}
                  ...
                  <div className="flex items-center gap-1.5 group/title">
                    ...
                    {onTitleChange && (
                      <span
                        ...
                        title="Edit section title"
                        className="text-stone-400 dark:text-stone-500 hover:text-stone-900 dark:hover:text-lime-300 transition-colors cursor-pointer flex-shrink-0 opacity-0 group-hover/title:opacity-100 focus-visible:opacity-100"
                      >
                        <Pencil className="w-3.5 h-3.5" />
                      </span>
                    )}
        ...
        {open && (
          <div className="px-4 pb-4 pt-3 border-t border-stone-200 dark:border-stone-800 space-y-4">
            {children}
          </div>
        )}
      </div>
