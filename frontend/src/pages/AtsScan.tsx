...
//           className="bg-white dark:bg-secondary p-6 rounded-lg shadow-[0_0_6px_rgba(0,0,0,0.2)]"
//         >
//           <ResumeScanForm
    ...
    <div className="font-plex min-h-screen bg-stone-50 dark:bg-stone-950 lg:pt-20 pb-12">
      <Wrapper>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.1 }}
          className="bg-white dark:bg-stone-900 p-6 rounded-2xl border border-stone-200 dark:border-stone-800"
        >
          <ResumeScanForm
            initialResumeFile={initialResumeFile}
            initialResumeName={initialResumeName}
